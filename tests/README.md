...
| `fide.rs` | FIDE game-over draws: fifty/seventy-five facts, threefold/fivefold repetition over real move sequences, known dead positions (plus the opposite-bishops negative), bare-mode toggle, mate precedence over coincident draw facts | `cargo test --locked -p shahmat --test fide` |

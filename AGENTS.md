...
Scope: every change in this repo. Source of truth for how to work; `docs/SPEC.md` is source of truth for what to build, `docs/PLAN.md` + `HANDOFF.md` for sequence and gates.
...
- `HANDOFF.md` / `docs/PLAN.md` push commands are gated triggers for a future release step, not standing permission.
...
- No new central docs folder or top-level markdown beyond what exists (`docs/SPEC.md`, `docs/PLAN.md`, `HANDOFF.md`, per-dir `README.md`) unless explicitly requested.
